export const RecipeData = [
  ...
  {
    recipeTitle: "Immunity Boosting Pumpkin Soup",
    ingredients: [
      { type: "yellow onion", amount: "1", section: "Produce" },
      { type: "sweet potatoes", amount: "2", section: "Produce" },
      { type: "garlic", amount: "1 clove", section: "Produce" },
      { type: "ginger", amount: "1 oz", section: "Produce" },
      { type: "cumin", amount: "1/4 oz", section: "Produce" },
      { type: "pumpkin puree", amount: "15oz", section: "Produce" },
      { type: "soy sauce", amount: "2oz", section: "Produce" },
      { type: "yeast", amount: "1oz", section: "NonPerishables" },
      { type: "kale", amount: "1 bunch", section: "Produce" },
      { type: "cilantro", amount: "1/2 oz", section: "Produce" },
      { type: "seasme seeds", amount: "2 1/4 oz", section: "Produce" },
    ],
    preparationTime: 60,
    preparationMeasurement: "minutes",
    requiredInstruments: ["Oven, blender"],
    instructions: [
      "Halve onion and thinly slice.",
      "Peel sweet potatoes and cut into ½-inch pieces.",
      "Finely chop 1 tablespoon garlic.",
      "Peel ginger and finely chop 1½ teaspoons. Thinly slice remaining ginger into matchsticks.",
      "In a small microwave-safe bowl, combine ginger matchsticks with just enough oil to cover them, about 4 tablespoons. Microwave until ginger is crisp and just starting to brown, 2-4 minutes (watch closely).",
      "Transfer ginger to paper towel to drain excess oil. Reserve remaining oil.",
      "In a large pot, heat 1 tablespoon reserved ginger oil over medium-high.",
      "Add onion and a pinch each of salt and pepper.",
      "Cook, stirring occasionally, until tender and translucent, 5-7 minutes.",
      "Add ginger, garlic, and 1 teaspoon cumin (or more to taste). Cook, stirring, until fragrant, about 1 minute.",
      "To pot with onions, add 6 cups water and pumpkin purée; bring to a simmer.",
      "Add sweet potatoes and cover.",
      "Reduce heat to low and cook, stirring occasionally, until potatoes are tender, about 15 minutes.",
      "Stir in ⅓ cup of the tamari and all of the nutritional yeast.",
      "Meanwhile, preheat broiler with a rack in the upper third.",
      "Remove and discard stems from kale leaves.",
      "Tear leaves into 1 inch pieces Transfer kale to a rimmed baking sheet; use your hands to massage with 1 tablespoon oil. Season with salt and pepper.",
      "Spread kale into an even layer and broil until tender and crisp in spots, about 5 minutes (watch closely).",
      "Puree soup with an immersion blender until smooth.",
      "Keep pot warm over low heat. Stir in ½ teaspoon vinegar and season to taste with salt and pepper.",
      "Remove cilantro leaves from stems and set aside.",
      "Spoon soup into bowls and garnish with sesame seeds, fried ginger, and cilantro leaves.",
      "Serve with some kale on top and the remaining on the side. Enjoy!",
    ],
    active: false,
    lillyRating: 2,
    week: 1,
    groceryList: false,
    calories: 350,
    resource: "Marley Spoon",
    resourceLink:
      "https://marleyspoon.com/menu/110351-immunity-boosting-pumpkin-soup-with-fried-ginger-crispy-kale",
    goToLink: "",
    otherRecipeLink: "",
  },
  {
  ...
  {
    recipeTitle: "Best Green Bean Casserole",
    ingredients: [
      {
        amount: "2 (14.5 ounce) cans",
        type: "green beans, drained",
        section: "NonPerishables",
      },
      {
        amount: "1 (10.5 ounce) can",
        type: "condensed cream of mushroom soup",
        section: "NonPerishables",
      },
      {
        amount: "1 cup",
