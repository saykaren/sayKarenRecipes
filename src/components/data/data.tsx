export const RecipeData = [
  ...
  },
  {
   ...
   { type: 'ground black pepper', section: "NonPerishables", amount: '1/4 tsp' },
   ...
   { type: 'Basmathi rice', section: "NonPerishables", amount: '1 cup' },
    ...
    preparationMeasurement: 'Minutes',
    requiredInstruments: [''],
    instructions: ['cook basmathi rice with tumeric','Mix dry rub together in ziplock bag', 'add chicken and mix dry rub with chicken', 'cube chicken and cook with bell peppers and onion', 'Serve with yogurt, rice and hummas'],
    active: false,
    lillyRating: 3,
    week: 1,
  groceryList: false,
