export const RecipeData = [
  ...
  },
  {
    ...
    instructions: [
      ...
      "Pulse, stirring a couple of times between pulses, until the mixture is just combined and sticks together. You don't want it to be too paste-like",
  ...
  {
    recipeTitle: "Homemade Chicken Yakisoba",
    ingredients: [
      { amount: "1/2 head", type: "green cabbage ", section: "NonPerishables" },
      { amount: "1 ", type: "yellow onion ", section: "NonPerishables" },
      { amount: "2", type: "carrots ", section: "NonPerishables" },
      { amount: "1 crown", type: "broccoli ", section: "NonPerishables" },
      { amount: "1 inch ", type: "fresh ginger ", section: "NonPerishables" },
      { amount: "1 large", type: "chicken breast ", section: "NonPerishables" },
      { amount: "2 Tbsp", type: "vegetable oil ", section: "NonPerishables" },
      {
        amount: "2 3oz. packages",
        type: "ramen noodles, seasoning packets discarded ",
        section: "NonPerishables",
      },
      {
        amount: "1 tsp ",
        type: "sesame oil, optional ",
        section: "NonPerishables",
      },
      { amount: "1/4 cup", type: "soy sauce ", section: "NonPerishables" },
      {
        amount: "1/4 cup",
        type: "worcestershire sauce ",
        section: "NonPerishables",
      },
      { amount: "2 Tbsp", type: "ketchup ", section: "NonPerishables" },
      { amount: "1 Tbsp", type: "sriracha ", section: "NonPerishables" },
      { amount: "1 Tbsp", type: "sugar", section: "NonPerishables" },
    ],
    preparationTime: 30,
    preparationMeasurement: "Minutes",
    requiredInstruments: [""],
    instructions: [
      ...
      "Peel and grate the carrots with a large holed cheese grater.Before you begin, prepare the meat and vegetables for stir frying.",
      "Peel the ginger with either a vegetable peeler or the side of a spoon and then grate it with a cheese grater.",
      "Peel and grate the carrots with a large holed cheese grater.",
      "Remove the core from the cabbage and cut into thin strips.",
      "Slice the onion into thin strips. Cut the broccoli into bite-sized pieces. Slice the chicken into thin strips.",
      ...
      "Use only 1/2 tsp of sriracha if you don’t want it spicy, use up to 1 Tbsp if you like it hot.",
      "Stir until the ketchup and sugar are dissolved.",
      "Pour the sauce into the skillet with the chicken and vegetables with the heat still on medium high. Add the noodles, stir to coat everything in the sauce, and heat through (just a few minutes). Remove the core from the cabbage and cut into thin strips. Slice the onion into thin strips.",
      "Cut the broccoli into bite-sized pieces. Slice the chicken into thin strips.",
      "Begin boiling a medium pot full of water for the noodles. Heat the vegetable oil in a large skillet over medium-high heat. ",
      "When the oil is hot, add the grated ginger, saute for about 30 seconds to one minute (its okay if it sticks to the pan but don’t let it burn). ",
      "Add the chicken strips and cook until they are no longer pink (about five minutes).",
      ...
      "Drain, return to the pot (with the heat turned off) and toss with the sesame oil to keep from sticking.",
      "In a small bowl, combine the soy sauce, worcestershire sauce, ketchup, sriracha, and sugar.",
      "Use only 1/2 tsp of sriracha if you don’t want it spicy, use up to 1 Tbsp if you like it hot. Stir until the ketchup and sugar are dissolved. ",
