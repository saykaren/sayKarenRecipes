export const RecipeData = [
  {
    ...
    ingredients: [
      ...
      { type: "Black pepper", section: "NonPerishables", amount: "1/2 Tablespoon" },
      { type: "Chicken Breast", section: "Meat", amount: "1-2" },
      { type: "Cornstarch", section: "NonPerishables", amount: "1 1/2 Tablespoon" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { type: "Taco Seasoning", section: "NonPerishables", amount: "2 Tablespoon" },
      { type: "Enchilada Sauce", section: "NonPerishables", amount: "28 ounces" },
      { type: "Corn - Frozen or Can", section: "Frozen", amount: "15 ounce" },
      { type: "Black Beans", section: "NonPerishables", amount: "15 ounce" },
      { type: "Ranch Style Beans", section: "NonPerishables", amount: "15 ounce" },
      { type: "Salsa", section: "NonPerishables", amount: "1 cup" },
      { type: "Chicken Broth or Stock", section: "NonPerishables", amount: "2 cups" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { type: "Ground Cumin", section: "NonPerishables", amount: "2 1/2 Teaspoon" },
      ...
      { type: "Chicken Broth or Stock", section: "NonPerishables", amount: "4 cups" },
      { type: "Coconut Milk", section: "NonPerishables", amount: "14 ounce can" },
      { type: "Tortillas", section: "NonPerishables", amount: "2/person" },
...

  {
    ...
    ingredients: [
      ...
      { type: "Red Curry Paste", section: "NonPerishables", amount: "1 Tablespoon" },
      { type: "Salt", section: "NonPerishables", amount: "1 Teaspoon" },
      { type: "Turmeric", section: "NonPerishables", amount: "1 Teaspoon" },
      { type: "Ground Ginger", section: "NonPerishables", amount: "1/2 Teaspoon" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { type: "Red Chile Powder", section: "NonPerishables", amount: "2 Tablespoons" },
      { type: "Flour", section: "NonPerishables", amount: "3 Tablespoons" },
      { type: "Vegetable/Olive Oil", section: "NonPerishables", amount: "3 Tablespoons" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { type: "Parsley - Dried", section: "NonPerishables", amount: "1 Teaspoon" },
      { type: "Minced Onion - Dried", section: "NonPerishables", amount: "2 Teaspoon" },
      { type: "Ranch Dressing", section: "NonPerishables", amount: "As desired" },
      { type: "Tortillas / Naan / Romain Lettuce", section: "Bread", amount: "2/person" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { type: "Black Pepper", section: "NonPerishables", amount: "1/2 Teaspoon" },
      { type: "Spaghetti", section: "NonPerishables", amount: "16 ounce" },
      { type: "Chicken Broth/Stock", section: "NonPerishables", amount: "3 cups" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { type: "Apple Cider Vinegar", section: "NonPerishables", amount: "2 Tablespoon" },
  ...
  },
  {
    ...
    ingredients: [
      { type: "Angel Hair Pasta", section: "NonPerishables", amount: "Never have enough" },
      {
        type: "Roasted Red Peppers (near pickles in store)",
        section: "NonPerishables", amount: "15 ounces",
      },
      ...
      { type: "Chipotle Spice-Ground", section: "NonPerishables", amount: "1 Teaspoon" },
  ...
  },
  {
    ...
    ingredients: [
      { type: "Roasted Green Chilies-fresh", section: "Produce", amount: "6-7" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { type: "Chili Beans in Chili Sauce", section: "NonPerishables", amount: "2- 30oz cans" },
      { type: "Tomato Sauce", section: "NonPerishables", amount: "2-29oz cans" },
      { type: "Whole Tomato-Canned", section: "NonPerishables", amount: "28oz" },
      { type: "Kidney Beans", section: "NonPerishables", amount: "2-26oz cans" },
      { type: "Pinto Beans", section: "NonPerishables", amount: "2-30oz" },
      { type: "Onion", section: "Produce", amount: "4" },
      { type: "Johnson brand frozen chili", section: "Frozen", amount: "1 tub" },
    ],
    preparationTime: 8,
    preparationMeasurement: "hours",
    requiredInstruments: ["Crock-Pot"],
  ...
  },
  {
    ...
    ingredients: [
      ...
      { type: "Avocado/Olive Oil", section: "NonPerishables", amount: "1 Tablespoon" },
      { type: "Chicken", section: "Meat", amount: "1-2" },
      { type: "Sea Salt", section: "NonPerishables", amount: "1/2 Teaspoon" },
      { type: "Black Pepper", section: "NonPerishables", amount: "1/4 Teaspoon" },
      ...
      { type: "Sea Salt-Sauce", section: "NonPerishables", amount: "2 Teaspoons" },
      { type: "Black Pepper-Sauce", section: "NonPerishables", amount: "To taste" },
  ...
  },
  {
    ...
    ingredients: [
      { type: "Chicken and Rice Soup", section: "NonPerishables", amount: "1 can" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { type: "Sweet and Sour Sauce", section: "NonPerishables", amount: "2 Tablespoons" },
  ...
  },
  {
    ...
    ingredients: [
      ...
      { type: "Beef Broth/Stock", section: "NonPerishables", amount: "1 1/4 cups" },
      { type: "White Mushrooms", section: "Produce", amount: "2 cups" },
      { type: "Worcestershire sauce", section: "NonPerishables", amount: "3 Tablespoon" },
      { type: "Garlic Cloves", section: "Produce", amount: "2" },
      { type: "Salt", section: "NonPerishables", amount: "1 Teaspoon" },
      { type: "Black Pepper", section: "NonPerishables", amount: "1/2 Teaspoons" },
      ...
      { type: "Dijon Mustard", section: "NonPerishables", amount: "2 Tablespoon" },
    ],
    preparationTime: 8,
    preparationMeasurement: "hours",
    requiredInstruments: ["Crock-Pot"],
  ...
  },
  {
    ...
    ingredients: [
      ...
      { type: "Baking Powder", section: "NonPerishables", amount: "3 1/2 Teaspoons" },
      { type: "Salt", section: "NonPerishables", amount: "1 Teaspoon" },
  ...
  },
  {
    recipeTitle: "Lasagna",
    ingredients: [
      { type: "Lasagne Noodles-Oven Ready", section: "NonPerishables", amount: "1" },
      ...
      { type: "Mozzarella Cheese-Shredded", section: "Dairy", amount: "4 cups" },
      { type: "Parmigiano-Reggiano Cheese", section: "Dairy", amount: "1/2 cup" },
    ],
    preparationTime: 0,
    preparationMeasurement: "hours",
    requiredInstruments: [],
  ...
  },
  {
    ...
    ingredients: [
      { type: "Romaine/Kale/Red Leaf", section: "Produce", amount: "1-2 Heads" },
  ...
  },
  {
    ...
    ingredients: [
      { type: "Chicken", section: "Meat", amount: "1-2" },
      { type: "Zesty Italian Dressing", section: "NonPerishables", amount: "1" },
  ...
  },
  {
    ...
    ingredients: [
      { type: "Tikka Masala Sauce", section: "NonPerishables", amount: "1-2 Jars" },
      { type: "Random Veggies", section: "NonPerishables", amount: "To Taste" },
      { type: "Basmati Rice", section: "NonPerishables", amount: "1-2 Cups" },
      { type: "Turmeric seasoning", section: "NonPerishables", amount: "To Taste" },
      { type: "Naan", section: "Bread", amount: "2/person" },
    ],
    preparationTime: 45,
    preparationMeasurement: "minutes",
  ...
  },
  {
    ...
    ingredients: [
      { type: "Italian Style Beef Meatballs - Kirkland", section: "NonPerishables", amount: "1/6 bag" },
      { type: "Tomato Paste", section: "NonPerishables", amount: "12oz" },
      { type: "Spaghetti sauce seasoning mix", section: "NonPerishables", amount: "2" },
      { type: "Spaghetti noodles", section: "NonPerishables", amount: "1/2 packet" },
    ],
    preparationTime: 30,
    preparationMeasurement: "minutes",
    requiredInstruments: [],
  ...
  },
  {
    ...
    ingredients: [
      { type: "Beef stew meat cubed", section: "NonPerishables", amount: "1-2lbs" },
      { type: "Beef Stew mix packet", section: "NonPerishables", amount: "1-2" },
  ...
  },
  {
    ...
    ingredients: [
      { type: "Chicken Cordon Bleu-Costco", section: "Meat", amount: "3 breasts" },
...

  {
    ...
    ingredients: [
      ...
      { type: "sushi grade nori", section: "NonPerishables", amount: "4 sheets" },
  ...
  },
  {
    ...
    ingredients: [{ type: 'Carrots', section: "Produce", amount: '3' },
    ...
    { type: 'Gomasio OR Rice Seasoning', section: "NonPerishables", amount: '2 Tsp' },
  ]
    ,
    preparationTime: 10,
    preparationMeasurement: 'Minutes',
