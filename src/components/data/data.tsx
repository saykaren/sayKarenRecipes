export const RecipeData = [
  ...
  },
  {
    ...
    instructions: [
      ...
      "Meanwhile, prep the zuchhini shells",
      ...
      "Sprinkle the insides of the zucchini shells with 1 tsp of the salt and leave to sweat out any excess moisutre whil you make the filling",
      "In a large nonstick skillet, heat the olive oil (2 tbs), over medium-high heat.",
      "Add garlic and cook until fragran, 30 seconds to a minute",
      "Add the turkey, chili poweder (1 tsp), salt (1 tsp), pepper (1/4 tsp)",
