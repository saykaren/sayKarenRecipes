export const RecipeData = [
  ...
  {
    recipeTitle: 'Homemade Green Bean Casserole',
    ingredients: [
      { amount: '2 lbs', type: 'green beans', section: 'NonPerishables' },
      { amount: '4 tbsp', type: 'unsalted butter', section: 'NonPerishables' },
      { amount: '1 lb', type: 'mushrooms cleaned and quartered', section: 'NonPerishables' },
      { amount: '¾ tsp', type: 'salt', section: 'NonPerishables' },
      { amount: '3 tbsp', type: 'all-purpose flour', section: 'NonPerishables' },
      { amount: '2 cloves', type: 'garlic', section: 'NonPerishables' },
      { amount: '2 tsp', type: 'Dijon mustard', section: 'NonPerishables' },
      { amount: '1 tbsp', type: 'Worcestershire sauce', section: 'NonPerishables' },
      { amount: '1 cup', type: 'whole milk', section: 'NonPerishables' },
      { amount: '¾ cup', type: 'chicken stock', section: 'NonPerishables' },
      { amount: '⅓ cup', type: 'sour cream', section: 'NonPerishables' },
      { amount: '½ tsp', type: 'black pepper', section: 'NonPerishables' },
    ...
    instructions: [
      ...
      'Mix the milk (1 cup) and chicken stock (3/4 cup) together and set it aside',
      'In a large skillet, melt 2 tbsp butter over medium heat. Once the butter is melted, add the prepared mushrooms (1 lb).',
      'Cook the mushrooms until they are evenly browned, 10-12 minutes.',
      'Once the mushrooms are browned, add the remaining 2 tbsp of butter and salt.',
      'Allow the butter to melt, and sprinkle the flour (3 tbsp) over the mushrooms.',
      'Stir and cook the flour for 1 minute. Add the minced garlic (2 cloves), Dijon mustard (2 tsp), and Worcestershire sauce (1 tbsp), and stir together.',
      
'Slowly drizzle in the milk mixture while stirring. Continue to add the milk mixture and stir until all of the mixture is added and smooth.',
'Return the mixture to a simmer. At this point, if the mixture is thin, continue to simmer until it thickens.',
'Once the sauce is thickened, remove it from the heat. Add the sour cream (⅓ cup), black pepper (½ tsp), and lemon juice (2 tsp), and stir until smooth.',
'Combine the green beans with the mushroom sauce',
'Pour the entire mixture into the prepared baking dish. Bake in the preheated oven until the sauce is bubbling throughout, 18-25 minutes.',
'top with french fried onions'
  ...
  calories: 240,
  resource: "Wyse Guide",
  resourceLink: "https://www.wyseguide.com/homemade-green-bean-casserole/#wprm-recipe-container-52014",
  goToLink: '',
  otherRecipeLink: '',
  },
    // {
