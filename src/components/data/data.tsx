export const RecipeData = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { type: 'Vegetable/Olive Oil', amount: '3 Tablespoons' },
  ...
  },
  {
    ...
    preparationMeasurement: 'hours',
    requiredInstruments: ['Crock-Pot'],
    instructions: ['Add all but the noodles, sour cream and dijon mustard to Crock-Pot.',
  ...
  },
  {
    ...
    ingredients: [
      ...
      { type: 'Eggs', amount: '1/person' },
      { type: 'Flour', amount: '1 1/2 cup' },
      { type: 'Baking Powder', amount: '3 1/2 Teaspoons' },
      { type: 'Salt', amount: '1 Teaspoon' },
      {type: 'Sugar', amount: '1 Tablespoon'},
      { type: 'Milk', amount: '1 1/4 cup' },
      { type: 'Egg', amount: '1' },
      { type: 'Butter', amount: '3 Tablespoons' },
        ],
    preparationTime: 1,
    preparationMeasurement: 'hours',
    requiredInstruments: [],
    instructions: ['Hash Browns-Shred potatoes into a large bowl filled with cold water. Stir until water is cloudy, drain and cover potatoes again with fresh cold water. Stir again to dissolve excess starch. Drain potatoes well, pat dry with paper towels. Heat butter on non-stick pan over medium heat. Sprinkle shredded potatoes into the hot butter and season with salt, pepper, italian seasoning. Cook until brown crust forms',
  ...
  {
    recipeTitle: 'Lasagna',
    ingredients: [{ type: 'Lasagne Noodles-Oven Ready', amount: '1' },
      { type: 'Marinara Sauce', amount: '2 Jars' },
      { type: 'Olive Oil', amount: '2 Tablespoon' },
      { type: 'Beef/Sausage-ground', amount: '1lb' },
      { type: 'Ricotta Cheese', amount: '15oz' },
      { type: 'Mozzarella Cheese-Shredded', amount: '4 cups' },
      { type: 'Parmigiano-Reggiano Cheese', amount: '1/2 cup' },
    ],
    preparationTime: 0,
    preparationMeasurement: 'hours',
    requiredInstruments: [],
  ...
  },
  {
    ...
    ingredients: [
        { type: 'Chicken', amount: '1-2' },
      { type: 'Onion-Purple', amount: '1' },
      { type: 'Shawarma Sauce ', amount: '1/2 Jar' },
      { type: 'Peppers-Green/Yellow', amount: '1-2' },
      { type: 'Basmati Rice', amount: '1-2 cups' },
      { type: 'Greek Yogurt', amount: '8 oz' },
      { type: 'Hummus', amount: '1' },
        ],
    preparationTime: 40,
    preparationMeasurement: 'minutes',
    requiredInstruments: ['Grill', 'Skewers', 'InstantPot'],
    instructions: ['Cube chicken and marinate in Shawarma sauce an hour or overnight if possible.',
      'Start grill',
  ...
  },
  {
    ...
    ingredients: [{ type: 'Tikka Masala Sauce', amount: '1-2 Jars' },
      { type: 'Random Veggies', amount: 'To Taste' },
      { type: 'Basmati Rice', amount: '1-2 Cups' },
      { type: 'Turmeric seasoning', amount: 'To Taste' },
      { type: 'Naan', amount: '2/person' },
    ],
    preparationTime: 45,
    preparationMeasurement: 'minutes',
    requiredInstruments: ['InstantPot'],
    instructions: ['Preheat oven for Naan',
  ...
  },
  {
    ...
    ingredients: [{ type: 'Italian Style Beef Meatballs - Kirkland', amount: '1/6 bag' },
      { type: 'Tomato Paste', amount: '12oz' },
      { type: 'Spaghetti sauce seasoning mix', amount: '2' },
      { type: 'Spaghetti noodles', amount: '1/2 packet' },
    ],
    preparationTime: 30,
    preparationMeasurement: 'minutes',
    requiredInstruments: [],
    instructions: ['Boil water and cook noodles per box instructions',
  ...
  },
  {
    ...
    ingredients: [{ type: 'Beyond Burger-Costco', amount: '1/person' },
      { type: 'Buns', amount: '1/person' },
      { type: 'Onion', amount: '1' },
      { type: 'Pickles', amount: '1' },
      { type: 'Tomato', amount: '1' },
      { type: 'Tots', amount: '1/2 bag' },
    ],
    preparationTime: 45,
    preparationMeasurement: 'minutes',
    requiredInstruments: [],
    instructions: ['Preheat oven for Tots',
      'Start grill',
  ...
  },
  {
    ...
    ingredients: [{ type: 'Beef stew meat cubed', amount: '1-2lbs' },
      { type: 'Beef Stew mix packet', amount: '1-2' },
      { type: 'Corn-Can/Frozen', amount: '1' },
      { type: 'Potatoes', amount: '2-3' },
      { type: 'Carrots', amount: '1-2' },
      { type: 'Green Beans - Can/Frozen', amount: '1' },
      { type: 'Muffin mix', amount: '1' },
    ],
    preparationTime: 8,
    preparationMeasurement: 'hours',
    requiredInstruments: ['Crock-Pot'],
    instructions: ['Cut up veggies',
  ...
  },
  {
    ...
    ingredients: [
        { type: 'Chicken Cordon Bleu-Costco', amount: '3 breasts' },
      { type: 'Potatoes', amount: '5' },
      { type: 'Milk', amount: '1/2 cup' },
      { type: 'Garlic Salt', amount: 'To Taste' },
      { type: 'Parmesan Cheese', amount: '1/4 cup' },
      { type: 'Gravy packet', amount: '1-2' },
        ],
    preparationTime: 1,
    preparationMeasurement: 'hours',
    requiredInstruments: [],
    instructions: ['Preheat oven per package of Chicken Cordon Bleu',
