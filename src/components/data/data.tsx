export const RecipeData = [
  ...
  },
  {
    ...
    resourceLink: "https://marleyspoon.com/menu/110351-immunity-boosting-pumpkin-soup-with-fried-ginger-crispy-kale",
    goToLink: "",
    otherRecipeLink: "",
  },
  {
  ...
  otherRecipeLink: '',
    ...
    ingredients: [
      ...
      { amount: '2 tbs', type: 'low sodium vegetable stock', section: "NonPerishables"},
      { amount: '1 tsp', type: 'thyme', section: "NonPerishables"},
      { amount: '2 tbs', type: 'parsley', section: "NonPerishables"},
      { amount: '4 cloves', type: 'garlic', section: "NonPerishables"},
      { amount: 'to taste', type: 'Salt and pepper', section: "NonPerishables"},
  ],
    preparationTime: 20,
    preparationMeasurement: 'minutes',
    requiredInstruments: [''],
...
'Season generously with salt and pepper, to taste, sprinkle with parsley (1 tbs) and serve the garlic butter mushrooms and cauliflower skillet immediately'
  ...
  calories: 0,
  resource: "EatWell",
  resourceLink: "https://www.eatwell101.com/garlic-mushrooms-cauliflower-recipe?pp=1",
  goToLink: '',
  otherRecipeLink: '',
  },
      // {
