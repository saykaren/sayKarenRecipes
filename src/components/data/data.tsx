export const RecipeData = [
  ...
  },
  {
    ...
    ingredients: [
      ...
      { amount: "1 teaspoon", section: "NonPerishables", type: " kosher salt" },
      {
        amount: "1 tablespoon",
        section: "NonPerishables",
  ...
  },
  {
    ...
    ingredients: [
      ...
      { amount: "3 tablespoons", type: "flour", section: "NonPerishables" },
  ...
  },
  {
    ...
    instructions: [
      ...
      "When garlic is cool enough to handle, squeeze cloves from skins (you should have about 6 tablespoons; discard skins",
  ...
  {
    recipeTitle: "Pozole Rojo (Mexican Pork and Hominy Stew)",
    ingredients: [
      {
        amount: "4 ounces",
        section: "NonPerishables",
        type: "dried guajillo or ancho chiles",
      },
      {
        amount: "1 large (108 ounce, 6 lb 12 oz, 3 kg) can",
        section: "NonPerishables",
        type: "white hominy, drained and rinsed",
      },
      { amount: "3 lbs", section: "NonPerishables", type: "pork shoulder" },
      { amount: "8 cloves", section: "NonPerishables", type: "garlic" },
      { amount: "3", section: "NonPerishables", type: "bay leaves" },
      { amount: "1 tsp", section: "NonPerishables", type: "ground cumin" },
      { amount: "2 tbs", section: "NonPerishables", type: "dry oregano" },
      { amount: "1/2 small", section: "NonPerishables", type: "cabbage" },
      { amount: "1 bunch", section: "NonPerishables", type: "cilantro" },
      { amount: "1/2", section: "NonPerishables", type: "white onion" },
      { amount: "2 ", section: "NonPerishables", type: "avocados" },
      { amount: "4", section: "NonPerishables", type: "limes" },
      { amount: "1 bunch", section: "NonPerishables", type: "red radishes" },
    ],
    preparationTime: 4,
    preparationMeasurement: "hours",
    requiredInstruments: ["Crock-Pot"],
    instructions: [
      "Boil water while prep or start crock-pot",
      "Prep pork shoulder -cut into 1 to 1 1/2 inch cubes (can also use pork shanks) ",
      "Prep garlic - 4 cloves roughly chopped and 4 whole cloves",
      "Prep cabbage - slice thinly",
      "Prep cilantro, onion and avacados - chopped",
      "Prep radishes - sliced thin",
      "Remove and discard the stems, seeds, and large veins from the chili pods.",
      "Heat a cast iron pan on medium high and heat the chili pods for a couple minutes, until they begin to soften. Do not let them burn.",
      ...
      "Heat a tbs or two of olive oil (enough to coat the bottom of the pan) in a large sauté pan on medium high heat.",
      ...
      "Add 3 bay leaves, cumin (1 tsp), and oregano (2 tbs).",
      "When you put the oregano in, smoosh together with your hands so that the oregano breaks up more as it goes in.",
