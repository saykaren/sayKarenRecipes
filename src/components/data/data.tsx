export const RecipeData = [
  ...
  {
    recipeTitle: "Chopped Winter Salad with Butternut Squash",
    ingredients: [
      { type: "Butternut squash", section: "Produce", amount: "2 lbs" },
      { type: "Olive Oil", section: "NonPerishables", amount: "1/4 cup" },
      { type: "Balsamic Vinegar", section: "NonPerishables", amount: "3 tbs" },
      { type: "Salt", section: "NonPerishables", amount: "1/4 tsp" },
      { type: "Pepper", section: "NonPerishables", amount: "1/4 tsp" },
      { type: "Dijon mustart", section: "NonPerishables", amount: "1 tbs" },
      { type: "Radicchio", section: "NonPerishables", amount: "1 head" },
      { type: "Romaine Lettuce hearts", section: "Produce", amount: "1" },
      { type: "fuji apple", section: "Produce", amount: "1" },
      {
        type: "Hazelnut, almonds or pecans toasted and chopped",
        section: "NonPerishables",
        amount: "1/2 cup",
      },
      { type: "Feta or goat cheese", section: "Dairy", amount: "1/2 cup" },
    ],
    preparationTime: 0,
    preparationMeasurement: "hours",
    requiredInstruments: ["oven"],
    instructions: [
      ...
      "Prepare squash - peeled, seeded and cut into 1/2 inch pieces",
      "Prepare apple - unpeeled, halved, cored and cut into 1/2 inch pieces",
      "Prepare Radicchio - trimmed, cored and sliced 1/2 inch thick",
      "Prepare Romain lettuce- cored and cut into 1inch thick pieces",
      "Toss squash with 1 tbs olive oil, 1 1/2 tsp balsamic vinegar, 1/4 tsp salt, and 1/4 tsp pepper",
      "Spread squash in single layer on aluminum foil lined rimmed baking sheet",
      "Roast until well brownded and tender 20 to 25 minutes, stirring halfway through roasting",
      "Remove sheet from oven and let squash cool for 5-10 minutes",
      "Whisk mustard, remaining 2 1/2 tbs balsamic vinegar, 1/8 tsp salt, and 1/8 tsp pepper together in large bowl",
      "Whisking constantly, slowly drizzle in remaining 3 tbs oil until emulsified",
      "Add radicchio, romaine and apple to bowl with dressing and toss to combine.",
      "Divide salad among individual plates",
      "Season with salt and pepper to taste.",
      "Serve, topping individual portions with squash, hazelnuts and feta",
    ],
    active: false,
    lillyRating: 3,
    week: 1,
